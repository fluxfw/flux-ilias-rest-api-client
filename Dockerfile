...
RUN (mkdir -p /build/flux-ilias-rest-api-client/libs/flux-autoload-api && cd /build/flux-ilias-rest-api-client/libs/flux-autoload-api && wget -O - https://github.com/fluxfw/flux-autoload-api/releases/download/v2022-07-12-1/flux-autoload-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxAutoloadApi FluxIliasRestApiClient\\Libs\\FluxAutoloadApi)

RUN (mkdir -p /build/flux-ilias-rest-api-client/libs/flux-ilias-base-api && cd /build/flux-ilias-rest-api-client/libs/flux-ilias-base-api && wget -O - https://github.com/fluxfw/flux-ilias-base-api/releases/download/v2022-07-12-1/flux-ilias-base-api-v2022-07-12-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxIliasBaseApi FluxIliasRestApiClient\\Libs\\FluxIliasBaseApi)
